...
const mockMascotas = [
  { id: '1', nombre: 'Max', tipo: 'Perro', estado: 'Perdido', ubicacion: 'Santiago Centro', foto: 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?auto=format&fit=crop&w=800&q=80' },
  { id: '2', nombre: 'Luna', tipo: 'Gato', estado: 'Encontrado', ubicacion: 'Providencia', foto: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?auto=format&fit=crop&w=800&q=80' },
  { id: '3', nombre: 'Rocky', tipo: 'Perro', estado: 'Perdido', ubicacion: 'Maipú', foto: 'https://images.unsplash.com/photo-1537151608804-ea2f1fa73a74?auto=format&fit=crop&w=800&q=80' },
  { id: '4', nombre: 'Milo', tipo: 'Gato', estado: 'Perdido', ubicacion: 'La Florida', foto: 'https://images.unsplash.com/photo-1495360010541-f48722b34f7d?auto=format&fit=crop&w=800&q=80' }
];
              ...
              <div className="p-5 flex flex-col flex-grow">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-xs text-slate-400 font-medium px-2 py-1 bg-slate-100 rounded-md">
                    {mascota.tipo || mascota.especie}
                  </span>
                </div>
                
                <p className="text-slate-500 text-sm flex items-center mt-1">
                  <span className="mr-1">📍</span> {mascota.direccionFormateada}
                </p>
